...
GOLDEN_ANSWERS = [
    GoldenAnswer(
        ...
        span_m=SPAN_M,
        options={"adverse": "maximum", "apply_footway_load": False},
        cases=1,
    ...
    GoldenAnswer(
        ...
        cross_section=DUAL_CARRIAGEWAY,
        span_m=SPAN_M,
        # Clause 206.1: a crowd is 500 kg/m2 = 4.905 kPa, not the flat 5.0 kPa this once used,
        # so only the footway part moved - by exactly 4.905 / 5.0 = 0.981.
        options={"adverse": "maximum", "apply_footway_load": True, "crowd_on_footways": True},
        cases=1,
        response=17033.098601913694,
        response_before_reduction=17033.098601913694,
        lane_reduction=1.0,
        design_lanes=2,
        lane_pattern="class_a | class_a",
        footway_response=2389.467214423186,
        residual_udl_applied=True,
        resultant_centred_response=16874.13061690686,
        total_over_all_cases=17033.098601913694,
        vehicles=[
            ("Class_A_reversed", 5.15, 4.199999999999999, (4.199999999999999,)),
            ("Class_A", 8.35, 12.0, (12.0,)),
        ],
